...
| Category | Band | Basis |
|---|---|---|
| **Overall Website Health** | Improving, real gaps remain | 18 verified defects found and fixed across 5 audit passes; 2 previously-blocked items resolved with real Admin API data (customer count, page-template assignments) rather than fixed; 10 more identified and logged, open — 2 of them just escalated from assumed-live to confirmed-live |
...
| **Content SEO** | **Critical gap, confirmed live (Verified)** | The real, published FAQ page shows Lorem Ipsum placeholder text (SEO-013, confirmed via real page-assignment data — not the unused `page.faq-02.json`) — actively worse than no FAQ page. Also confirmed live: a fake Ecomus "Store Locator" page with London/Madrid/Tokyo demo content (SEO-030), and two duplicate policy pages (SEO-031) |
