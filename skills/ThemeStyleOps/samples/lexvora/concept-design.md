<picture>
  ...
  <img alt="Concept & Design" src="../../assets/banners/lexvora/concept-design-light.svg" width="100%">
</picture>
...
| ---:  | --- | --- | --- |
| 1 | Clients self-serve their own API keys | ![Planned](../../assets/badges/lexvora/planned.svg) | `PLAN-03` |
| 2 | One dashboard for all client activity | ![Confirmed](../../assets/badges/lexvora/confirmed.svg) | `PLAN-01` |
| 3 | Usage alerts are opt-in per client | ![Proposed](../../assets/badges/lexvora/proposed.svg) | Unmapped |
| 4 | White-label branding per client | ![Future / Held](../../assets/badges/lexvora/future-held.svg) | Not scheduled |
...
| ---:  | --- | --- | --- |
| 1 | Do clients need sub-accounts? | ![Open Question](../../assets/badges/lexvora/open-question.svg) | Concept 1 |
| 2 | Who owns key revocation? | ![Open Question](../../assets/badges/lexvora/open-question.svg) | Concept 1 |
| 3 | Is SSO mandatory for all tiers? | ![Resolved by Addition](../../assets/badges/lexvora/resolved-by-addition.svg) | Answered in `ADR-001` |
