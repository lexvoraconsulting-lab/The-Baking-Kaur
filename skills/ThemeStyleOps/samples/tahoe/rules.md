<picture>
  ...
  <img alt="Rules" src="../../assets/banners/tahoe/rules-light.svg" width="100%">
</picture>
...
| ---:  | --- | --- | --- |
| 1 | No client data in logs, ever | All code | ![Confirmed](../../assets/badges/tahoe/confirmed.svg) |
| 2 | Every schema change ships with a reversible migration | Database | ![Confirmed](../../assets/badges/tahoe/confirmed.svg) |
| 3 | Every Plan task links to a source record | Documentation | ![Confirmed](../../assets/badges/tahoe/confirmed.svg) |
| 4 | Secrets never enter process arguments | All code | ![Confirmed](../../assets/badges/tahoe/confirmed.svg) |
| 5 | Public API changes need an accepted Decision first | API | ![Proposed](../../assets/badges/tahoe/proposed.svg) |
