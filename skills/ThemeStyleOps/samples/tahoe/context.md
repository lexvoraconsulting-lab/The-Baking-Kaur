<picture>
  ...
  <img alt="Context" src="../../assets/banners/tahoe/context-light.svg" width="100%">
</picture>
...
| ---:  | --- | --- | --- |
| 1 | Authentication | ![Confirmed](../../assets/badges/tahoe/confirmed.svg) | Single sign-on is live for internal users. |
| 2 | Client onboarding | ![In Delivery](../../assets/badges/tahoe/in-delivery.svg) | Two of five screens are built. |
| 3 | Reporting | ![Draft](../../assets/badges/tahoe/draft.svg) | Requirements captured, not evaluated. |
| 4 | Billing export | ![On Hold](../../assets/badges/tahoe/on-hold.svg) | Waiting on the finance system upgrade. |
...
| ---:  | --- | --- | --- |
| 1 | The finance API stays on v2 until Q4 | ![Risk High](../../assets/badges/tahoe/risk-high.svg) | Architect |
| 2 | Client count stays under 500 | ![Risk Low](../../assets/badges/tahoe/risk-low.svg) | Delivery lead |
| 3 | No offline mode is required | ![Risk Medium](../../assets/badges/tahoe/risk-medium.svg) | Product |
